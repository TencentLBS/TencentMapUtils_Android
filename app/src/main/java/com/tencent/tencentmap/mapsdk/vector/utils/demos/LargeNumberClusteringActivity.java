 ...
 *
 */
public class LargeNumberClusteringActivity extends Activity {
...
//        //默认聚合生效距离，35dp
        ...
        PreCachingAlgorithmDecorator<TencentMapItem> pcad =
                new PreCachingAlgorithmDecorator<TencentMapItem>(ndba);
        mClusterManager.setAlgorithm(pcad);
        ...
        //设置最小聚合数量，默认为 4，这里设置2，即 cluster 中有2个以上(不包括2) marker 才进行聚合操作。
